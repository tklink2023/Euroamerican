...
If !SCR->(DbSeek(xFilial("SC7")+"PC"+Padr(HttpPost->numpc,TamSX3("CR_NUM")[1])+HttpPost->nivapr))
	cMsgHdr		:= "BEP0201C - Alçada Não Encontrada"
...
ElseIf SCR->CR_STATUS <> "02"
	...
	cMsgHdr		:= "BEP0201B - Transferência Superior Cancelada"
