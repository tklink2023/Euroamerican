...
/*/
//--------------------------------------------------------------------
User Function UPDSD4A( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UPDSD4A" )
				Else
					MsgStop( "Atualização não realizada.", "UPDSD4A" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Doc.Movto   '															, ; //X3_TITSPA
	'Doc.Movto   '															, ; //X3_TITENG
	'Doc.Movimento     '													, ; //X3_DESCRIC
	'Doc.Movimento	   '													, ; //X3_DESCSPA
	'Doc.Movimento     '													, ; //X3_DESCENG
	'@!'        			  												, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
PutSX1Help( "PD4_XDOC", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "PD4_XDOC" )
