...
/*/
//--------------------------------------------------------------------
User Function UPDSB1C( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UPDSB1C" )
				Else
					MsgStop( "Atualização não realizada.", "UPDSB1C" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Tp Compra'																, ; //X3_TITSPA
	'Tp Compra'																, ; //X3_TITENG
	'Tipo de Compras'														, ; //X3_DESCRIC
	'Tipo de Compras'														, ; //X3_DESCSPA
	'Tipo de Compras'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'Pertence("PSF")'														, ; //X3_VLDUSER
	'P=Primaria;S=Segundaria;Fora Uso'			    						, ; //X3_CBOX
	'P=Primaria;S=Segundaria;Fora Uso'		    							, ; //X3_CBOXSPA
	'P=Primaria;S=Segundaria;Fora Uso'	    								, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDSB1C" ) ) ) ;
