...
/*/
//--------------------------------------------------------------------
User Function UPDSB1E( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
aAdd( aSX3, { ;
	...
	15																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod.Descon'															, ; //X3_TITULO
	'Cod.Descon'															, ; //X3_TITSPA
	'Cod.Descon'															, ; //X3_TITENG
	'Cod. Descontinuado'													, ; //X3_DESCRIC
	'Cod. Descontinuado'													, ; //X3_DESCSPA
	'Cod. Descontinuado'													, ; //X3_DESCENG
	'@!' 	    			  												, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
PutSX1Help( "PB1_XCODDES", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "B1_XCODDES" )
