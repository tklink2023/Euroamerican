...
/*/
//--------------------------------------------------------------------
User Function UPDSB1D( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UPDSB1D" )
				Else
					MsgStop( "Atualização não realizada.", "UPDSB1D" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	9																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Qt Pallete  '															, ; //X3_TITULO
	'Qt Pallete  '															, ; //X3_TITSPA
	'Qt Pallete  '															, ; //X3_TITENG
	'Quantidade Pallete'													, ; //X3_DESCRIC
	'Quantidade Pallete'													, ; //X3_DESCSPA
	'Quantidade Pallete'													, ; //X3_DESCENG
	'@R 99999'     			  												, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
PutSX1Help( "PB1_XPALLETE", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "B1_XPALLETE" )
