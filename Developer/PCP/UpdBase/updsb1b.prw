...
/*/
//--------------------------------------------------------------------
User Function UPDSB1B( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UPDSB1B" )
				Else
					MsgStop( "Atualização não realizada.", "UPDSB1B" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	'SB1'																	, ; //X3_ARQUIVO
	'FR'																	, ; //X3_ORDEM
	'B1_XPERTENC'															, ; //X3_CAMPO
	'C'																		, ; //X3_TIPO
	15																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pertence Emp'															, ; //X3_TITULO
	'Pertence Emp'															, ; //X3_TITSPA
	'Pertence Emp'															, ; //X3_TITENG
	'Pertence a Empresa'													, ; //X3_DESCRIC
	'Pertence a Empresa'													, ; //X3_DESCSPA
	'Pertence a Empresa'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
//
aHlpPor := {}
aAdd( aHlpPor, 'O Material pertence a empresa ' )
aAdd( aHlpPor, 'onde será inventariado' )

PutSX1Help( "PB1_XPERTENC", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "B1_XPERTENC" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDSB1B" ) ) ) ;
