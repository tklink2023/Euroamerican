...
Do Case
		Case ( nOpcUsr >= 3 .And. nOpcUsr <= 8 ) .And. .Not. lUsrOpc  .and. !( lPORTASUP .and. nOpcUsr == 4 )
			_cUsrSemAc := Getmv("ES_PARFAT2")
  			Help( ,, "FATX011 Gerenciam.Carga",, OemToAnsi("Opcao nao disponivel para o seu usuario. Este acesso ้ liberado atrav้s do parametro ES_PARFAT2 para: ") + ENTER + subs(_cUsrSemAc,1,40) + ENTER +subs(_cUsrSemAc,41,40) + ENTER +subs(_cUsrSemAc,81,40) + ENTER +subs(_cUsrSemAc,121,40)  + ENTER +subs(_cUsrSemAc,161,40)  + ENTER +subs(_cUsrSemAc,201,40)  , 1, 0 )
			Restarea( aArea )
			Return

		Case nOpcUsr == 9 .And. .Not. lUsrOpc09
			//MsgStop("Opcao nao disponivel para o seu usuario. Este acesso ้ liberado atrav้s do parametro ES_PARFAT4 para: " + Getmv("ES_PARFAT4") )
			_cUsrSemAc := Getmv("ES_PARFAT4")
  			Help( ,, "FATX011 Gerenciam.Carga",, OemToAnsi("Opcao nao disponivel para o seu usuario. Este acesso ้ liberado atrav้s do parametro ES_PARFAT4 para: ") + ENTER + subs(_cUsrSemAc,1,40) + ENTER +subs(_cUsrSemAc,41,40) + ENTER +subs(_cUsrSemAc,81,40) + ENTER +subs(_cUsrSemAc,121,40)  + ENTER +subs(_cUsrSemAc,161,40)  + ENTER +subs(_cUsrSemAc,201,40)  , 1, 0 )
			Restarea( aArea )
			Return

		Case nOpcUsr == 10 .And. .Not. lUsrOpc10
			//MsgStop("Opcao nao disponivel para o seu usuario. Este acesso ้ liberado atrav้s do parametro ES_PARFAT5 para: " + Getmv("ES_PARFAT5") )
			_cUsrSemAc := Getmv("ES_PARFAT5")
 	   		//Help( ,, "FATX011 Gerenciam.Carga",, OemToAnsi("Opcao nao disponivel para o seu usuario. Este acesso ้ liberado atrav้s do parametro ES_PARFAT5 para: ") + ENTER + _cUsrSemAc  , 1, 0 )
  			Help( ,, "FATX011 Gerenciam.Carga",, OemToAnsi("Opcao nao disponivel para o seu usuario. Este acesso ้ liberado atrav้s do parametro ES_PARFAT5 para: ") + ENTER + subs(_cUsrSemAc,1,40) + ENTER +subs(_cUsrSemAc,41,40) + ENTER +subs(_cUsrSemAc,81,40) + ENTER +subs(_cUsrSemAc,121,40)  + ENTER +subs(_cUsrSemAc,161,40)  + ENTER +subs(_cUsrSemAc,201,40)  , 1, 0 )
			Restarea( aArea )
			Return
EndCase
